...
- [type ErrorRepository](<#ErrorRepository>)
  - [func \(r \*ErrorRepository\[T\]\) Create\(item T\) \(uint, error\)](<#ErrorRepository[T].Create>)
  - [func \(r \*ErrorRepository\[T\]\) Delete\(id uint\) error](<#ErrorRepository[T].Delete>)
  - [func \(r \*ErrorRepository\[T\]\) GetAmountQuantity\(\) \(int, error\)](<#ErrorRepository[T].GetAmountQuantity>)
  - [func \(r \*ErrorRepository\[T\]\) GetById\(id uint\) \(\*T, error\)](<#ErrorRepository[T].GetById>)
  - [func \(r \*ErrorRepository\[T\]\) GetByLimitOffset\(limit, offset int\) \(\[\]T, error\)](<#ErrorRepository[T].GetByLimitOffset>)
  - [func \(r \*ErrorRepository\[T\]\) Update\(item \*T\) error](<#ErrorRepository[T].Update>)


<a name="ErrorRepository"></a>
...
<a name="ErrorRepository[T].Create"></a>
### func \(\*ErrorRepository\[T\]\) Create
...
<a name="ErrorRepository[T].Delete"></a>
### func \(\*ErrorRepository\[T\]\) Delete
...
<a name="ErrorRepository[T].GetAmountQuantity"></a>
### func \(\*ErrorRepository\[T\]\) GetAmountQuantity
...
<a name="ErrorRepository[T].GetById"></a>
### func \(\*ErrorRepository\[T\]\) GetById
...
<a name="ErrorRepository[T].GetByLimitOffset"></a>
### func \(\*ErrorRepository\[T\]\) GetByLimitOffset
...
<a name="ErrorRepository[T].Update"></a>
### func \(\*ErrorRepository\[T\]\) Update
